...
2. Download the [sh script](https://github.com/cvescan/cvescan/blob/master/Packs/McAfee_DXL/Integrations/McAfee_DXL/create_keys/create_keys.sh) and move it to the new directory.
3. Run the script.
...
1. In ePO server go to **Menu > Server Settings**.
    ![go to menu](https://github.com/cvescan/cvescan/raw/master/Packs/McAfee_DXL/Integrations/McAfee_DXL/create_keys/img/go_to_menu.png)
    ![go to server settings](https://github.com/cvescan/cvescan/raw/master/Packs/McAfee_DXL/Integrations/McAfee_DXL/create_keys/img/go_to_serevr_settings.png)
2. Under DXL certificates (Third Party) click **Edit**.
    ![click edit](https://github.com/cvescan/cvescan/raw/master/Packs/McAfee_DXL/Integrations/McAfee_DXL/create_keys/img/click_edit.png)
3. download the brokers certificate.
    ![export Broker certificates](https://github.com/cvescan/cvescan/raw/master/Packs/McAfee_DXL/Integrations/McAfee_DXL/create_keys/img/export_Broker_certificates.png)
4. Download the brokers list.
    ![export Broker list](https://github.com/cvescan/cvescan/raw/master/Packs/McAfee_DXL/Integrations/McAfee_DXL/create_keys/img/export_Brocker_list.png)
5. Click **Import** and select the **client.crt** file.
    ![click import](https://github.com/cvescan/cvescan/raw/master/Packs/McAfee_DXL/Integrations/McAfee_DXL/create_keys/img/click_import.png)
    ![select client.crt file](https://github.com/cvescan/cvescan/raw/master/Packs/McAfee_DXL/Integrations/McAfee_DXL/create_keys/img/select_client.crt_file.png)
    ![click ok](https://github.com/cvescan/cvescan/raw/master/Packs/McAfee_DXL/Integrations/McAfee_DXL/create_keys/img/click_ok.png)
6. Click **Save**.
    ![click save](https://github.com/cvescan/cvescan/raw/master/Packs/McAfee_DXL/Integrations/McAfee_DXL/create_keys/img/click_save.png)
