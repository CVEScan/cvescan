...
![ExtraHop detection card](https://github.com/cvescan/cvescan/raw/master/Packs/ExtraHop/doc_files/ExtraHop_Detection_CVE-2019-0708_BlueKeep.png)

*Figure 1. Reveal(x) detection card for CVE-2019-0708 RDP Exploit Attempt*

![Cortex XSOAR playbook: ExtraHop Default](https://github.com/cvescan/cvescan/raw/master/Packs/ExtraHop/doc_files/ExtraHop_Default.png)

*Figure 2. Reveal(x) Default playbook to set up ticket tracking and run the BlueKeep playbook*

![Cortex XSOAR playbook: ExtraHop CVE-2019-0708 BlueKeep](https://github.com/cvescan/cvescan/raw/master/Packs/ExtraHop/doc_files/ExtraHop_CVE-2019-0708_BlueKeep.png)
