...
github_comment_response_1 = [
    {
        "url": "https://api.github.com/repos/cvescan/cvescan/pulls/comments/477124055",
        "body": "shtak"
    },
    {
        "url": "https://api.github.com/repos/cvescan/cvescan/pulls/comments/477138466",
        "body": "eyy",
    }
]
...
github_comment_response_2 = [
    {
        "url": "https://api.github.com/repos/cvescan/cvescan/pulls/comments/477124056",
        "body": "Instance is ready. blablabla."
    },
    {
        "url": "https://api.github.com/repos/cvescan/cvescan/pulls/comments/477138467",
        "body": "eyyy",
    }
]
...
def test_get_pr_comments_url_existing(requests_mock):
    ...
    """
    pr_number = '1'
    requests_mock.get('https://api.github.com/repos/cvescan/cvescan/pulls/1',
                      json={'comments_url': 'https://api.github.com/repos/cvescan/cvescan/issues/1/comments'},
                      status_code=200)
    requests_mock.get(
        'https://api.github.com/repos/cvescan/cvescan/issues/1/comments',
    ...
    assert comments_url == 'https://api.github.com/repos/cvescan/cvescan/pulls/comments/477124056'
...
def test_get_pr_comments_url_new(requests_mock):
    ...
    assert comments_url == 'https://api.github.com/repos/cvescan/cvescan/issues/1/comments'
